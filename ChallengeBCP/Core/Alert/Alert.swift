...
struct Alert {
    ...
    static func showErrorAlert(on vc: UIViewController,
                               message: String,
                               handler: ((UIAlertAction) -> Void)? = nil) {
        showBasicAlert(on: vc, with: message,
                       message: message, handler: handler)
    }
    
    static func showEmptyAlert(on vc: UIViewController, title: String, message: String, handler: ((UIAlertAction) -> Void)? = nil) {
        showBasicAlert(on: vc, with: title,
                       message: message, handler: handler)
    }
